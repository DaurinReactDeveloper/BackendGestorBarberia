    ...
    public class ComentarioServices : IComentarioService
    {
        ...
        public ServiceResult GetComentarios()
        {
            ...
            try
            {
                ...
                if (!ComentarioValidations.VerifyNull(Comentarios))
                {
        ...
        public ServiceResult GetComentsByBarbero(int barberoId)
        {
            ...
            try
            {
                ...
                if (!ComentarioValidations.VerifyNull(ComentariosBarbero))
                {
        ...
        public ServiceResult GetComentsByCliente(int clienteId)
        {
            ...
            try
            {
                ...
                if (!ComentarioValidations.VerifyNull(ComentariosCliente))
                {
        ...
        public ServiceResult Add(ComentarioaddDto modelDto)
        {
            ...
            try
            {
                ...
                if (!ComentarioValidations.AddValidations(modelDto))
                {
                    result.Success = false;
                ...
                this.comentarioRepository.Add(new Domain.Entities.Comentarios()
                {
        ...
        public ServiceResult Update(ComentarioUpdateDto modelDto)
        {
            ...
            try
            {
                ...
                if (!ComentarioValidations.VerifyId(modelDto.IdComentarios))
                {
                ...
                if (!ComentarioValidations.UpdateValidations(modelDto))
                {
                    result.Success = false;
        ...
        public ServiceResult Remove(ComentarioRemoveDto modelDto)
        {
            ...
            try
            {
                ...
                if (!ComentarioValidations.RemoveValidations(modelDto))
                {
                    result.Success = false;
                    result.Message = "El comentario no cumple con las validaciones para eliminarlo.";
                    return result;
                }
