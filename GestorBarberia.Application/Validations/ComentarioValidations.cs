...
namespace GestorBarberia.Application.Validations
{
    public static class ComentarioValidations
    {
        ...
        public static bool AddValidations(ComentarioaddDto comentarioAddDto)
        {
        ...
        public static bool UpdateValidations(ComentarioUpdateDto comentarioUpdateDto)
        {
        ...
        public static bool RemoveValidations(ComentarioRemoveDto comentarioRemoveDto)
        {
        ...
        public static bool VerifyNull(List<ComentarioModel> comentarioModels)
        {
